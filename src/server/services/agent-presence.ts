...
/**
 * Server-side mirror of the UI "quiet run" threshold. Re-exports the
 ...
 *
 * Use this for any tRPC proc that filters active runs as "quiet / needing
 * attention" (agent detail page, dashboard agent-activity tile, kick
 ...
 */
export { QUIET_RUN_MS, STALE_RUN_MS } from "@/lib/agent-stale";
