  ...
  return (
    <Dialog open={open} onClose={() => setOpen(false)}>
      ...
      <ul className="max-h-96 overflow-y-auto py-1">
        {issueItems.length > 0 && (
          <li className="px-3 py-1 text-[10px] uppercase tracking-wider text-muted-foreground">
            Issues
          </li>
        )}
        ...
        {filteredNav.length > 0 && (
          <li className="mt-1 px-3 py-1 text-[10px] uppercase tracking-wider text-muted-foreground">
            Navigate
          </li>
        )}
