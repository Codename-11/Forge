...
PR review caught thirteen identity/bounded-prefix/race edge cases before merge. Lifecycle
...
49 tests; lint passed with existing repository warnings; typecheck passed; and
