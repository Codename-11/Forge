...
- **The claim holder shows a name, not a raw id.** An issue's sidebar used to read "Claimed by `a1b2c3d4`". It now shows the claimer as a proper badge (avatar + name), with the short id kept as quiet subtext.
