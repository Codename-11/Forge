...
| Router            | Procedures                                                                                                                                                                                                                                                                                                                                                                                                   |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `workspace`       | `list`, `current`, `create`, `listMembers`, `invite`, `listInvitations`, `resendInvitation`, `revokeInvitation`, `addMember`, `setMemberRole`, `removeMember` (invitation and member mutations are admin-gated)                                                                                                                                                                                                |
